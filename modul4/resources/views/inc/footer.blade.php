<footer style="box-shadow:inset 0px 2px 10px 0px #3B82F6;" class="flex flex-row gap-20 bg-gray-600 rounded-t-xl py-7 pl-20 pr-20">
    ...
    <div class=" mx-5 ml-10 flex-1">
        ...
        <p class="text-xs text-gray-200 hover:text-blue-500"><a href="/store/no_order">Store</a></p>
        <p class="text-xs text-gray-200 hover:text-blue-500"><a href="/cart">Cart</a></p>
    ...
    <div class=" flex-1">
        ...
        <p class="text-xs text-gray-200 hover:text-blue-500"><a href="/#contact_form_index">Contact us</a></p>
    </div>
