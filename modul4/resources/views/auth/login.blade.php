                ...
                <div class="my-20 flex flex-col">
                    <div class="bg-gray-700 p-6 w-80 m-auto rounded-3xl">
                        <div class="text-gray-300 font-bold border-b w-24 mb-4 border-gray-300">{{ __('Login') }}</div>
                            <input placeholder="Email" id="email" type="email" class="text-white bg-transparent border-b border-gray-600 form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                            @error('email')
                            ...
                            <input placeholder="Password" id="password" type="password" class="mt-4 text-white bg-transparent border-b border-gray-600 form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
